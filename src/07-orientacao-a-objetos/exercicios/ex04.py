...
class Projeto:
    ...
    def __str__(self):
        resultado = f'Projeto[codigo={self.codigo}, titulo={self.titulo}, responsavel={self.responsavel}, códigos das participações=['
...
# Classe Participacao (alterada para usar add_participacao automaticamente)
class Participacao:
